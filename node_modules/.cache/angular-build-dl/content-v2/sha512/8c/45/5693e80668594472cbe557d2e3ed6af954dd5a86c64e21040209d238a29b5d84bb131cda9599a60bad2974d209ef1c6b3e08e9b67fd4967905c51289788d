...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~share-circle-share-circle-module~subscribed-doctor-circle-subscribed-doctor-circle-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppShareCircleShareCirclePageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppShareCircleShareCirclePageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppShareCircleShareCirclePageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ShareCirclePage", function () {
      return ShareCirclePage;
    });
    /* harmony import */
    ...
    var ShareCirclePage = /*#__PURE__*/function () {
      function ShareCirclePage(navParams, popoverCtrl, clipBoard, authService) {
        _classCallCheck(this, ShareCirclePage);
      ...
      _createClass(ShareCirclePage, [{
        ...
        key: "copyCodePass",
        value: function copyCodePass() {
          console.log("Circle object--->", this.circleObj); // let copyText = "Circle Code :"+this.circleObj.circleCode+" "+"Circle Password :"+this.circleObj.circlePassword;

          alert(this.sendTxt);
          this.clipBoard.copy(this.sendTxt).then(function (data) {
            alert("code copied");
          });
        }
      }, {
        key: "codeShareLink",
        value: function codeShareLink(e) {
        ...
        value: function getCountryCode() {
          ...
          this.authService.getCountryCodes().subscribe(function (data) {
            console.log("country codes--", data);
            _this.countryCodeList = data;
          });
        }
      }, {
        key: "mobileNoChange",
        value: function mobileNoChange(e) {
        ...
        value: function countryCodeChange() {
          if (this.countryCode != "") {
    ...
    ShareCirclePage.ctorParameters = function () {
      return [{
    ...
    ShareCirclePage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-share-circle',
      template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! raw-loader!./share-circle.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/share-circle/share-circle.page.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./share-circle.page.scss */
      "./src/app/share-circle/share-circle.page.scss"))["default"]]
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavParams"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["PopoverController"], _ionic_native_clipboard_ngx__WEBPACK_IMPORTED_MODULE_3__["Clipboard"], _auth_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"]])], ShareCirclePage);
    /***/
  }
}]);
//# sourceMappingURL=default~share-circle-share-circle-module~subscribed-doctor-circle-subscribed-doctor-circle-module-es5.js.map